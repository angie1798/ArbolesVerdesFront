...
<div className='container-left d-flex'>
    ...
    <div className='container-section1-texts'>
        ...
        <h3 className='outfit-semibold text-green bigger-title'>en pro de la conservación</h3>
        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed ac justo nisi. Nullam metus eros, dignissim.</p>
    </div>
</div>
...
<div className='como-donar d-flex'>
    <div className='container-left justify-content-start'>
        ...
        <p className='roboto-regular'>Podés donar a través de una transacción bancaria y también mediante sinpe móvil.</p>
        </div>
        <div className='d-flex iconos-donacion-container'>
            <div className='w-50 d-flex'>
            <BsCreditCardFill className='iconos-donacion text-beige'/>
            <h4 className='poppins-regular fontSize-16 text-beige'>TRANSFERENCIA <br/>BANCARIA</h4>
            </div>
            <div className='w-50 d-flex'>
            <FaMobile className='iconos-donacion text-beige'/>
            <h4 className='poppins-regular fontSize-16 text-beige'>SINPE <br/> MOVIL</h4>
            </div>
        </div>
        <div className='d-flex iconos-donacion-container'>
            <div className='w-50'>
